...
export class TutorialService {
  ...
  getCik(ticker: string): Observable<string> {
    return this.http.get<string>(`${baseUrl}companies/cik/${ticker}`);
  }

  getFundamentalData(ticker: string): Observable<Fundamentals[]> {
    return this.http.get<Fundamentals[]>(`${baseUrl}fundamentals/${ticker}`);
  }
  ...
  getFundamentals(cik: string): Observable<any> {
    return this.http.post<any>(`${baseUrl}companies/fundamentals`, {
      cik: cik,
    });
  }
